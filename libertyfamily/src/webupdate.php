...
$wizard = 0;
    ...
    */
	...
	$sql = "INSERT INTO membres VALUES('".$tag."', '".$playername."', '".$expLevel."', '".$trophies."', '".$warStars."', '".$townHallLevel."', 'LibertyZ', '".$king."','".$queen."','".$warden."','".$archer."','".$balloon."','".$barbarian."','".$bowler."','".$dragon."','".$giant."','".$goblin."','".$golem."','".$healer."','".$hogrider."','".$lavahound."','".$miner."','".$minion."','".$pekka."', '".$valkyrie."','".$wallbreaker."','".$witch."','".$wizard."')";
			        if ($conn->query($sql) === TRUE) 
        {
            $compteurSQL++;
        } 
